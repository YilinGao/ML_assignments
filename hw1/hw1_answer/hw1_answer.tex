...
\begin{enumerate}
	...
	Compare to the plot on training data, the perceptron weights have lower accuracy on testing data. Although the discrepancy is not very large, but the accuracy on testing data is smaller for almost all epochs. This indicates the algorithm overfits a bit on the training data.
