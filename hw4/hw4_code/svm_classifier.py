...
class SVMClassifier:
    ...
    def train(self, X, y):
        ...
        If the data is not separable, raise an exception, set self.undefined to False, and leave optimal variables as None
    ...
    def predict(self, X):
        ...
        Exceptions:
            ClassifierUndefinedError: raised when the classifier status is undefined
        """
